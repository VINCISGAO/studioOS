...
const copy = {
  en: {
    title: "Start your next campaign on StudioOS.",
    subtitle: "Structured briefs, matched studios, and escrow-backed delivery — in days, not months.",
    primary: "Create ad brief",
    secondary: "Talk to us"
  },
  zh: {
    title: "在 StudioOS 上启动下一个投放项目。",
    subtitle: "结构化需求简报、匹配制作方、托管交付 — 几天而非几个月。",
    primary: "创建广告需求",
    secondary: "联系我们"
  }
};
        ...
        <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-zinc-950 px-8 py-16 text-center text-white sm:px-16 sm:py-20">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button asChild size="lg" className="h-11 rounded-lg bg-white px-6 text-zinc-950 hover:bg-zinc-100">
