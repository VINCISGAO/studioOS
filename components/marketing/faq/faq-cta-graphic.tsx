...
export function FaqLucienCtaGraphic({ locale }: { locale: Locale }) {
  return (
    <img
      ...
      className="pointer-events-none absolute bottom-0 right-3 z-10 h-[min(220px,54vw)] w-auto max-w-none object-contain object-bottom sm:right-5 sm:h-[min(252px,46vw)] lg:right-8 lg:h-[276px]"
    />
  );
}
