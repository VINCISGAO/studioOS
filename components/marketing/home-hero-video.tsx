...
export { HERO_VIDEO_SRC } from "@/lib/hero-video";
  ...
  return (
    ...
    >
      <video
        ...
        className="pointer-events-none absolute left-1/2 top-1/2 h-full w-full min-h-full min-w-full -translate-x-1/2 -translate-y-1/2 object-cover opacity-[0.42]"
