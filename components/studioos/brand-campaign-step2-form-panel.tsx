...
const copy = {
  en: {
    ...
    accuracyHint: "Required before you can continue to the next step.",
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="overflow-hidden rounded-2xl border border-zinc-200/80 bg-white shadow-sm">
        ...
        <div className="border-t border-amber-200/80 bg-gradient-to-b from-amber-50/90 to-amber-50/40 px-5 py-5 sm:px-6">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-xs text-amber-800/80">{t.accuracyHint}</p>
              <label
                className={cn(
                  "mt-4 flex cursor-pointer items-start gap-3 rounded-xl border bg-white px-4 py-4 shadow-sm transition",
                  certified
              ...
              >
                <input
                  ...
                  className="mt-0.5 h-4 w-4 shrink-0 rounded border-zinc-300 text-violet-600 focus:ring-violet-600"
                />
                <span className="text-sm font-medium leading-6 text-zinc-800">{t.certify}</span>
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="flex gap-3 rounded-2xl border border-violet-100 bg-violet-50/50 px-5 py-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-relaxed text-zinc-600">{t.tipBody}</p>
        </div>
      </div>
    </div>
  );
