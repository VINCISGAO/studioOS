...
const copy = {
  en: {
    ...
    subtitle: "Funds are held until you approve delivery. Matching starts after payment.",
    amount: "Order total",
    fee: "Platform fee",
  ...
  zh: {
    title: "托管付款",
    subtitle: "款项托管至你确认交付后释放。付款完成后才开始匹配 Creator。",
    amount: "订单总额",
    fee: "平台服务费",
    payout: "Studio 收入",
    method: "付款方式",
    ...
    paidTitle: "托管中",
    paidBody: "Campaign 已付款，可以开始匹配 Creator。",
    copy: "复制",
    copied: "已复制",
    secure: "256 位加密 · 托管保障"
  }
