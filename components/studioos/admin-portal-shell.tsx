...
const navItems: NavItem[] = [
  ...
  { key: "languages", href: adminPortalRoutes.languages, icon: Languages, iconKey: "settings", section: "primary" },
  { key: "showcase", href: adminPortalRoutes.showcase, icon: Clapperboard, iconKey: "campaigns", section: "primary" },
