...
- 不要太早生成项目。
- 不要在付款前消耗 AI token。
- 品牌方付款成功以后，才进入创作者匹配和邀约。
- 创作者接受邀约不等于合作达成。
- 只有品牌方最终在已经接受邀约的创作者中确认某个 Creator 并点击合作后，才生成 Active Project / 正式项目表单。
...
1. 品牌方发布需求：填写需求、上传素材、预算、时间、参考风格。
2. 品牌方点击“提交需求”；系统只保存需求，不生成 AI 创意，不创建正式项目。
3. 品牌方确认需求后进入付款。
4. 付款成功后进入 AI 创作者匹配阶段；UI 显示 3 秒弹窗动画：“AI 正在为你匹配最适合的 Creator。”
5. 系统根据品类、风格、预算、交付时间、创作者能力、历史合作、品牌方偏好、收藏/浏览行为等维度匹配真实注册 Creator。
...
11. Creator 接受或拒绝后，品牌方都必须收到通知。
12. 品牌方进入“接受邀约的 Creator 列表”，可以查看 Creator 主页、作品集、AI 推荐理由、价格、交付能力、风格匹配度。
13. AI 可以推荐最佳人选，但品牌方可以不选 AI 推荐的人。
14. 如果品牌方没有选择 AI 推荐人，记录 `Brand ignored AI recommendation` 并进入 AI 学习。
15. 创作者寻找完毕后，品牌方可以点击“换一批 Creator”，最多 3 批；每次换一批都记录 AI 学习事件。
16. 如果 3 批都没有满意人选，停止继续推荐，并显示退款选项：“没有找到合适的 Creator，你可以选择退款。”
17. 品牌方最终选择某位已接受邀约的 Creator 后，点击“确认合作”。
...
- 不允许系统自动生成 AI 创意。
- AI 创意必须由品牌方或 Creator 主动点击触发。
- AI 创意只是参考方向，不是最终稿。
- 真正的定稿创意，必须经过品牌方与 Creator 之间的确认。
...
1. 创作者上传第一版，品牌方收到推送。
2. 品牌方可以对第一稿要求修改，创作者收到推送。
3. 或者品牌方直接通过并释放款项，创作者收到推送，项目结束。
4. 创作者上传第二版，品牌方收到推送。
5. 品牌方第二稿修稿，创作者收到推送。
6. 创作者上传第三版，品牌方收到推送。
7. 品牌方第三稿可以通过并释放款项，项目结束。
8. 如果第三稿仍不满意，要进入第四次修改，必须拉起付费。
9. 品牌方支付项目成交价 20% 的加付费用。
10. 支付完成后进入第四稿修改意见。
11. 创作者收到推送：品牌方已加付该项目成交价 20%。
12. 创作者上传第四版，品牌方收到推送。
13. 品牌方第四稿修稿，创作者收到推送。
14. 创作者上传第五版，品牌方收到推送。
15. 品牌方第五稿通过并释放款项，项目结束。
16. 如果第五稿仍不满意，不能继续普通修稿，必须进入客服仲裁。
17. 不管是第一稿、第二稿、第三稿、第四稿还是第五稿，只要品牌方满意并点击通过，系统就完成款项释放，项目结束。
