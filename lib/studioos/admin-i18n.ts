...
export const adminNavLabels: Record<AdminNavKey, Record<Locale, string>> = {
  ...
  credits: { en: "Credits", zh: "Credits 财务" },
  creditsPricing: { en: "Pricing rules", zh: "模型计费" },
...
export const adminActivityLabels: Record<string, Record<Locale, string>> = {
  ...
  "credits.reserved": { en: "Credits reserved", zh: "Credits 已冻结" },
  "credits.captured": { en: "Credits captured", zh: "Credits 已扣费" },
  "credits.released": { en: "Credits released", zh: "Credits 已释放" },
  "credits.admin_adjusted": { en: "Credits adjusted by admin", zh: "管理员调整 Credits" },
  "credits.purchase_credited": { en: "Credits purchase credited", zh: "Credits 充值入账" },
  "credits.purchase_refunded": { en: "Credits purchase refunded", zh: "Credits 充值退款" },
