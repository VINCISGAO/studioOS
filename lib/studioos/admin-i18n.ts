...
export const adminActivityLabels: Record<string, Record<Locale, string>> = {
  ...
  "credits.reserved": { en: "Token reserved", zh: "Token 已冻结" },
  "credits.captured": { en: "Token captured", zh: "Token 已扣费" },
  "credits.released": { en: "Token released", zh: "Token 已释放" },
  "credits.admin_adjusted": { en: "Token adjusted by admin", zh: "管理员调整 Token" },
  "credits.purchase_credited": { en: "Token purchase credited", zh: "Token 充值入账" },
  "credits.purchase_refunded": { en: "Token purchase refunded", zh: "Token 充值退款" },
