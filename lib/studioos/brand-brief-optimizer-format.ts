...
/** Quick Brief textarea — strategy & creative only; duration/platforms are chosen in the form. */
export function formatQuickBriefPolishedDocument(optimizer: BrandBriefOptimizerResult, locale: Locale) {
