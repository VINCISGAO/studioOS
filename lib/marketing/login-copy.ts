import type { LoginPageCopy } from '@/components/studioos/login-page-shell';

export type LoginMarketingCopy = LoginPageCopy & {
  configError: string;
  unsupported: string;
  wrongRoleHint: string;
};

const loginCopyByUiLocale: Record<"en" | "zh", LoginMarketingCopy> = {
  en: {
...
export const loginCopyEn = loginCopyByUiLocale.en;
export const loginCopyZhCN = loginCopyByUiLocale.zh;
