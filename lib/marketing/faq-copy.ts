...
const zh: FaqCopy = {
  ...
  categories: [
      ...
      items: [
        {
          question: "VINCIS 是什么？",
          answer:
            "VINCIS 是一个连接全球品牌与 AI 创作者的平台。品牌可以快速找到合适的创作者完成广告制作，创作者也能获得来自全球的真实商业项目。"
        },
        {
          question: "注册需要付费吗？",
          answer:
            "注册、浏览平台和完善个人资料均免费。部分 AI 专业功能及高级会员服务需要升级后使用。"
        },
        {
          question: "品牌和创作者需要注册不同账号吗？",
          answer: "不需要。一个账号即可拥有 Brand 与 Creator 两种身份，你可以根据需要自由切换。"
        }
      ]
    },
    {
      ...
      items: [
        {
          question: "如何发布一个项目？",
          answer:
            '进入 Brand Portal，点击「发布项目」，填写需求、预算、交付时间等信息即可。AI 会帮助整理需求并生成专业 Brief。'
        },
        {
          question: "为什么 AI 会给我预算建议？",
          answer:
            "VINCIS 不采用随机报价。系统会根据项目复杂度、视频时长、AI 制作成本、创作者工时、修改次数以及历史成交数据，智能计算合理预算。"
        },
        {
          question: "我的预算低于 AI 建议怎么办？",
          answer:
    ...
    },
    {
      ...
      items: [
        {
          question: "Creator 如何接单？",
          answer:
            "项目发布后，AI 会根据专业能力、作品、报价、地区及项目需求智能匹配创作者，也支持品牌主动邀请。"
        },
        {
          question: "我可以拒绝项目吗？",
          answer: "可以。拒绝不会影响账号，但建议填写拒绝原因，帮助 AI 提供更精准的项目推荐。"
        },
        {
          question: "Creator 如何获得付款？",
    ...
    },
    {
      ...
      items: [
        {
          question: "AI 会替我完成整个广告吗？",
          answer:
            "不会。AI 更像一位创意顾问，它可以帮助整理需求、生成创意方向、推荐制作方案，并协助品牌与创作者提升效率。最终作品仍由专业创作者完成。"
        },
        {
          question: "AI 为什么推荐这个 Creator？",
          answer: "AI 会综合分析以下维度，所有推荐都来自真实数据，而不是随机排序。",
          bullets: [
            "专业能力",
            "历史作品",
            "项目经验",
        ...
        {
          question: "为什么 Professional 才能使用 Moodboard？",
          answer:
            "AI Moodboard、Storyboard、Prompt Package 等功能需要大量 AI 计算资源。Professional 会员可解锁这些高级创意工具，以获得更完整的创意策划体验。"
        }
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          question: "平台如何收费？",
          answer:
            "VINCIS 采用透明的平台服务费模式。服务费包含 AI 智能分析、项目匹配、托管支付、审片中心、文件管理及平台运营等完整服务。"
        },
        {
          question: "为什么平台收取服务费？",
          answer:
            "平台不仅提供交易撮合，还提供完整的广告制作协作系统，包括 AI 工具、在线审片、版本管理、全球支付、安全保障及项目管理服务。"
        }
      ]
    },
    {
      ...
      items: [
        {
          question: "如何加入 Partner Program？",
          answer: "申请通过后即可获得专属推广链接或邀请码。成功推荐品牌完成交易后，即可获得平台奖励。"
        },
        {
          question: "Partner 如何获得佣金？",
          answer:
  ...
  publicLucien: {
    ...
    suggestions: [
      ...
      "如何发布一个项目？",
      "什么是托管付款？",
      "为什么 Professional 才能使用 Moodboard？"
    ]
  }
};
