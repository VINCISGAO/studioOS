...
export const landingCopy = {
  ...
  hero: {
    en: {
      ...
      subtitle: "Premium advertising is no longer exclusive to big companies",
      primary: "I'm a brand",
...
const landingCopyTranslations: Partial<{
  ...
  hero: {
    ...
    ja: {
      ...
      subtitle: "トップクラスの広告はもう大企業だけのものではない",
      primary: "ブランドとして始める",
      secondary: "スタジオとして参加",
    ...
    ko: {
      ...
      titleHighlight: "",
      titleLine2: "AI 크리에이터",
      subtitle: "최고급 광고는 더 이상 대기업만의 전유물이 아닙니다",
      primary: "브랜드로 시작하기",
    ...
    ms: {
      ...
      subtitle: "Iklan bertaraf tinggi bukan lagi eksklusif untuk syarikat besar",
    ...
    km: {
      ...
      subtitle: "ពាណិជ្ជកម្មកំពូលលែងជារបស់សម្រាប់តែក្រុមហ៊ុនធំទៀតហើយ",
    ...
    th: {
      ...
      subtitle: "โฆษณาระดับท็อปไม่ใช่สิทธิพิเศษของบริษัทใหญ่อีกต่อไป",
    ...
    vi: {
      ...
      subtitle: "Quảng cáo hàng đầu không còn là đặc quyền của các tập đoàn lớn",
    ...
    fr: {
      ...
      subtitle: "La publicité premium n'est plus l'apanage des grandes entreprises",
    ...
    es: {
      ...
      subtitle: "La publicidad de primer nivel ya no es exclusiva de las grandes empresas",
