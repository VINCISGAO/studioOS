...
const zh: PricingCopy = {
  ...
  titleAccent: "更容易开始。",
  intro:
    "VINCIS 通过 AI Production Pricing Engine，根据项目复杂度、视频长度、交付速度等因素，为您提供透明、合理的专业报价。",
  philosophy:
  ...
  principles: [
    ...
    {
      title: "成本透明",
      body: "平台服务费覆盖 AI、匹配、托管、审片、协作、存储与安全保障等完整基础设施，每一项都有明确依据。"
    },
    {
      title: "托管支付保障",
  ...
  trustPoints: [
    ...
    {
      title: "创作者生态保障",
      body: "合理定价保障创作者收益，吸引全球优秀 Studio。"
    },
    {
      title: "持续学习进化",
