...
export const creators: Creator[] = [
  {
    ...
    ai_tags: ["产品广告", "美妆个护", "科技数码", "CG特效", "动态视觉"],
    profile_completed_at: "2026-06-20T09:00:00Z",
    order_rating_count: 28,
...
export const creatorWorks: CreatorWork[] = [
  {
    ...
    video_url: "/videos/home/recent-work/luxury-serum-launch.mp4",
