...
if (run("git diff --cached --quiet") !== 0) {
  run(
    'git commit -m "chore(homepage): re-anchor golden baseline (homepage-v1)." -m "2026-07-11 owner lock: hero subtitle「顶级广告不再是大公司专属」all 11 locales, mobile/iPad/desktop responsive layout frozen, HomeHeroVideo player frozen, mobile card nav, hero Earth + CTA breakpoints, cost table mobile. Hero videos cv=7 unchanged. See docs/HOMEPAGE_GOLDEN.md."'
  );
} else {
