...
const faqs = {
  en: [
    ["Is StudioOS a freelancer marketplace?", "No. StudioOS is a production workflow OS for brands and studios — brief, pipeline, review, delivery."],
  ...
  zh: [
    ["StudioOS 是自由职业平台吗？", "不是。StudioOS 是 Brand 与 Studio 的制作工作流 OS：Brief、流水线、审片、交付。"],
