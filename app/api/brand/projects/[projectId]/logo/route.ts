...
import { uploadBrandLogoImage } from "@/lib/studioos/brand-logo-image-service";
...
export async function POST(
  ...
  let result: Awaited<ReturnType<typeof uploadBrandLogoImage>>;
  try {
    result = await uploadBrandLogoImage({
      projectId,
      clientEmail,
      file,
      locale: lang
